...
namespace elara {
    ...
    String ProjectBuilder::renderUiCppAppHeader(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(app_name);
        attrs.append(app_name.toUpperCase());
        return loadTemplate("UiApp.h", "main", attrs);
    }
    ...
    String ProjectBuilder::renderUiCppMain(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(app_name);
        attrs.append(options.socket_address);
        attrs.append(String(options.socket_port));
        return loadTemplate("UiCppMain.cpp", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaVmHostHeader(const ProjectOptions &options) {
        ...
        attrs.append(class_name.toUpperCase());
        return loadTemplate("EpaVmHost.h", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaVmHostCpp(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(class_name);
        return loadTemplate("EpaVmHost.cpp", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugShimHeader(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(prefix);
        attrs.append(prefix.toUpperCase());
        return loadTemplate("EpaDebugShim.h", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugShimC(const ProjectOptions &options) {
        ...
        attrs.append(prefix);
        attrs.append(prefix.toUpperCase());
        return loadTemplate("EpaDebugShim.c", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugServiceHeader(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(prefix);
        attrs.append(service_name);
        attrs.append(service_name.toUpperCase());
        attrs.append(host_name);
        attrs.append(shim_name);
        return loadTemplate("EpaDebugService.h", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugServiceCpp(const ProjectOptions &options) {
        ...
        attrs.append(prefix.toUpperCase());
        attrs.append(service_name);
        return loadTemplate("EpaDebugService.cpp", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugServerHeader(const ProjectOptions &options) {
        ...
        attrs.append(server_name.toUpperCase());
        attrs.append(service_name);
        return loadTemplate("EpaDebugServer.h", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugServerCpp(const ProjectOptions &options) {
        ...
        attrs.append(server_name);
        attrs.append(service_name);
        return loadTemplate("EpaDebugServer.cpp", "main", attrs);
    }
    ...
    String ProjectBuilder::renderEpaDebugMain(const ProjectOptions &options) {
        ...
        StringList attrs;
        attrs.append(server_name);
        return loadTemplate("EpaDebugMain.cpp", "main", attrs);
    }

    String ProjectBuilder::renderUiPythonApp(const ProjectOptions &options) {
        StringList attrs;
        attrs.append(options.project_name);
        attrs.append(options.target_name);
        attrs.append(options.socket_address);
        attrs.append(String(options.socket_port));
        attrs.append(boolTemplateValue(options.ui_template == ProjectOptions::UI_TEMPLATE_RICH_EDITOR));
        attrs.append(boolTemplateValue(options.include_python_multi_cpu_template));
        return loadTemplate("app.py", "main", attrs);
    }

    String ProjectBuilder::renderUiPythonPackageInit(const ProjectOptions &options) {
        StringList attrs;
        attrs.append(boolTemplateValue(options.include_python_multi_cpu_template));
        return loadTemplate("__init__.py", "main", attrs);
    }
    ...
    String ProjectBuilder::renderUiPythonWorkerTemplate(const ProjectOptions &options) {
        (void)options;
        return loadTemplate("worker_template.py", "main", StringList());
    }

    String ProjectBuilder::renderUiPythonMultiCpuHelper(const ProjectOptions &options) {
        (void)options;
        return loadAsset("python/multi_cpu.py");
    }
