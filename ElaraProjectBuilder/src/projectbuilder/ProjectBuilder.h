...
namespace elara {
    ...
    private:
        ...
        String renderRunEpaDebugScript(const ProjectOptions &options);
        String renderReadme(const ProjectOptions &options);
        String renderMainCpp(const ProjectOptions &options);
        String renderUiCppAppHeader(const ProjectOptions &options);
        String renderUiCppAppCpp(const ProjectOptions &options);
        String renderUiCppMain(const ProjectOptions &options);
        String renderEpaVmHostHeader(const ProjectOptions &options);
        String renderEpaVmHostCpp(const ProjectOptions &options);
        String renderEpaDebugShimHeader(const ProjectOptions &options);
        String renderEpaDebugShimC(const ProjectOptions &options);
        String renderEpaDebugServiceHeader(const ProjectOptions &options);
        String renderEpaDebugServiceCpp(const ProjectOptions &options);
        String renderEpaDebugServerHeader(const ProjectOptions &options);
        String renderEpaDebugServerCpp(const ProjectOptions &options);
        String renderEpaDebugMain(const ProjectOptions &options);
