...
int main(int argc, const char *argv[]) {
    ...
    if (!count || !selected_count) {
        ...
        printf("Validator selectors: all, runtime, runtime.bytearray, runtime.hashmap, runtime.ringbuffer, runtime.base58, runtime.base64, runtime.commandline, runtime.indexeddatastore, runtime.indexeddatastore.integrity, runtime.indexeddatastore.crash\r\n");
