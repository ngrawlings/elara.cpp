...
- `epa/io/block/partition/partition_io_authority.e`: partition IO authority layered above raw block IO. It owns partition-table interpretation and later mount discovery should derive from what it reads from disk, not from Python-side drive config.
