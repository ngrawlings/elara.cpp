...
def build_document():
    ...
    ui.create_window("EpaSignalLab", 1080, 760, "org.elara.ui.epa-signal-lab")
    ...
    ui.add_grid_row_exact("app.panel", 24)
    ui.create_label("app.title", "EpaSignalLab control surface", 18)
...
def _run_as_external_logic(session_path: str) -> None:
    ...
    client.register(name="epa-signal-lab")
