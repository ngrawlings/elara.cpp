#ifndef ORANGEFORTRESSEPAFRAME_H
#define ORANGEFORTRESSEPAFRAME_H
...
struct OrangeFortressEpaFrameHeader {
    bool valid;
    uint32_t magic;
    uint32_t version;
    uint32_t width;
...
OrangeFortressEpaFrameHeader orangeFortressParseEgressFrameHeader(const void *data, size_t len);
String orangeFortressFrameHeaderJson(const OrangeFortressEpaFrameHeader &header, const String &direction, const String &schema);
