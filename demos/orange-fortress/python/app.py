...
def build_document():
    ...
    ui.create_window("OrangeFortress", 1080, 760, "org.elara.ui.orange-fortress")
    ...
    ui.add_grid_row_exact("app.panel", 24)
    ui.create_label("app.title", "OrangeFortress control surface", 18)
...
def _run_as_external_logic(session_path: str) -> None:
    ...
    client.register(name="orange-fortress")
