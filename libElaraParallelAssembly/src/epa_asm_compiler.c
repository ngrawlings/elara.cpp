...
static const AsmInsnDesc *find_desc(const char *mn) {
  ...
  static const AsmInsnDesc kDesc[] = {
    ...
    {"MUL_F32",    EPA_OP_MUL_F32,               0,0, 0,{0}, NULL, "MUL_F32 takes no params"},
    {"DIV_F32",    EPA_OP_DIV_F32,               0,0, 0,{0}, NULL, "DIV_F32 takes no params"},
    {"NEG_F32",    EPA_OP_NEG_F32,               0,0, 0,{0}, NULL, "NEG_F32 takes no params"},
    {"SQRT_F32",   EPA_OP_SQRT_F32,              0,0, 0,{0}, NULL, "SQRT_F32 takes no params"},
    {"LT_F32",     EPA_OP_LT_F32,                0,0, 0,{0}, NULL, "LT_F32 takes no params"},
    {"LE_F32",     EPA_OP_LE_F32,                0,0, 0,{0}, NULL, "LE_F32 takes no params"},
    {"GT_F32",     EPA_OP_GT_F32,                0,0, 0,{0}, NULL, "GT_F32 takes no params"},
    {"GE_F32",     EPA_OP_GE_F32,                0,0, 0,{0}, NULL, "GE_F32 takes no params"},
    {"EQ_F32",     EPA_OP_EQ_F32,                0,0, 0,{0}, NULL, "EQ_F32 takes no params"},
    {"NE_F32",     EPA_OP_NE_F32,                0,0, 0,{0}, NULL, "NE_F32 takes no params"},
    {"I32_TO_F32", EPA_OP_I32_TO_F32,            0,0, 0,{0}, NULL, "I32_TO_F32 takes no params"},
    {"F32_TO_I32", EPA_OP_F32_TO_I32,            0,0, 0,{0}, NULL, "F32_TO_I32 takes no params"},
    {"U32_TO_F32", EPA_OP_U32_TO_F32,            0,0, 0,{0}, NULL, "U32_TO_F32 takes no params"},
    {"F32_TO_U32", EPA_OP_F32_TO_U32,            0,0, 0,{0}, NULL, "F32_TO_U32 takes no params"},
	...
	{"GR_MOV4",     EPA_OP_GR_MOV4,               1,1, 1,{AK_U8}, NULL, "GR_MOV4 <rx:u8> (uses r0=idx, r1=gen, r2=off; returns rx=value)"},
	{"GW_MOV4",     EPA_OP_GW_MOV4,               1,1, 1,{AK_U8}, NULL, "GW_MOV4 <rx:u8> (uses r0=idx, r1=gen, r2=off; writes rx=value)"},
    {"G_ALLOC_L",  EPA_OP_G_ALLOC_L,             0,0, 0,{0}, NULL, "G_ALLOC_L (uses r0=type,r1=size,r2=lbytes_off; returns r0=idx,r1=gen)"},
    {"RGM_PUBLISH_L", EPA_OP_RGM_PUBLISH_L,       0,0, 0,{0}, NULL, "RGM_PUBLISH_L (uses r0/r1=name uid,r2=lbytes_off,r3=size; returns r0=idx,r1=gen,r2=size,r3=ok)"},
    {"RGM_GET",       EPA_OP_RGM_GET,             0,0, 0,{0}, NULL, "RGM_GET (uses r0/r1=name uid; returns r0=idx,r1=gen,r2=size,r3=ok)"},
    {"RGM_META",      EPA_OP_RGM_META,            0,0, 0,{0}, NULL, "RGM_META (uses r0=idx,r1=gen; returns r0=name_lo,r1=name_hi,r2=size,r3=gen)"},
    {"RGM_READ4",     EPA_OP_RGM_READ4,           1,1, 1,{AK_U8}, NULL, "RGM_READ4 <rx:u8> (uses r0=idx,r1=gen,r2=off; returns rx=value)"},
